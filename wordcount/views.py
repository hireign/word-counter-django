...
def home(request):
    ...
    return render(request, 'home.html', {'fulltext': fulltext, 'onelinetext':onelinetext, 'original_spaces':original_spaces, 'filteredtext':filteredtext, 'paragraphs':paragraphs, 'all_total': all_total, 'char_total': char_total, 'words_total': words_total})
